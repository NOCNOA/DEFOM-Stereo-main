...
python make_submission.py \
--restore_ckpt checkpoints/defomstereo_vits_multi/defomstereo_vits_multi_300000.pth \
--scale_iters 100 \
--valid_iters 200 \
--idepth_scale 0.5 \
--corr_levels 2 \
...
python make_submission.py \
--restore_ckpt checkpoints/defomstereo_vits_sceneflow/defomstereo_vits_sceneflow_200000.pth  \
