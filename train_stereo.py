...
from core.defom_hw_galerkin import DEFOMStereo
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', default=123098, type=int)
    ...
    parser.add_argument('--max_disp', type=int, default=160, help="maximum disparity")
