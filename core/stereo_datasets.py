...
#     def __init__(self, aug_params=None, root='/home/share/yijiayi/sceneflow/', dstype='frames_cleanpass', things_test=False):
...
#         root = osp.join(self.root, 'FlyingThings3D')  #/home/share/yijiayi/sceneflow/FlyingThings3D/frames finalpass/TEST/B/0025/left/0010.png
...
#     def __init__(self, aug_params=None, root='/home/share/yijiayi/eth3d', split='training', is_eval=False, is_test=False):
...
#     def __init__(self, aug_params=None, root='/home/share/yijiayi/kitti/', split='2015', image_set='training', is_eval=False, is_test=False):
...
#         if split == '15':
#             print("as111",os.path.join(root, image_set, 'image_2/*_10.png'),flush=True)
#             #/home/share/yijiayi/kitti/2015/training/image_2/*_10.png
...
#             #print("aaaaa", len(image1_list), len(image2_list), len(disp_list), flush=True)
#         else:
#             #print("as111",sorted(glob(os.path.join(root, image_set, 'image_2/*_10.png'))),flush=True)
#             #/home/share/yijiayi/kitti/2012/training/colored_0/*_10.png
#             #/home/share/yijiayi/kitti/2012/training/image_2/000000_10.png
...
#                 root, 'training/disp_occ/000085_10.png')] * len(image1_list)
#         #print("asdasd",len(image1_list),flush=True)   #200   
...
#     def __init__(self, aug_params=None, root='/home/share/yijiayi/Middlebury', split='F', image_set='training', is_eval=False, is_test=False):
...
class SceneFlowDatasets(StereoDataset):
    def __init__(self, aug_params=None, root='/data/public_data/', dstype='frames_cleanpass', things_test=False):
        super(SceneFlowDatasets, self).__init__(aug_params, is_eval=things_test)
        self.root = root
        self.dstype = dstype
...
class ETH3D(StereoDataset):
    def __init__(self, aug_params=None, root='/data/public_data/eth3d/', split='training', is_eval=False, is_test=False):
        super(ETH3D, self).__init__(aug_params, sparse=True, is_eval=is_eval, is_test=is_test)
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='/data/lidanyang_data/kitti/', split='2015', image_set='training', is_eval=False, is_test=False):
        super(KITTI, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispKITTI, is_eval=is_eval, is_test=is_test)
...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='/data/licanheng_data/middlebury', split='F', image_set='training', is_eval=False, is_test=False):
        super(Middlebury, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispMiddlebury, is_eval=is_eval, is_test=is_test)
        assert os.path.exists(root)
        assert split in ["F", "H", "Q", "2005", "2006", "2014", "2021"]
        assert image_set in ["training", "test"]
...
class SintelStereo(StereoDataset):
    def __init__(self, aug_params=None, root='/data2/yijiayi_data/Sintel/Sintel'):
        super().__init__(aug_params, reader=frame_utils.readDispSintelStereo)
        #/data2/yijiayi_data/Sintel/Sintel/training/clean_left/alley_1/frame_0001.png
        image1_list = sorted(glob(osp.join(root, 'training/*_left/*/frame_*.png')))
        image2_list = sorted(glob(osp.join(root, 'training/*_right/*/frame_*.png')))
        disp_list = sorted(glob(osp.join(root, 'training/disparities/*/frame_*.png'))) * 2
...
class FallingThings(StereoDataset): #/data/public_data/FallingThings/OpenDataLab___FAT/raw/fat/mixed/kitchen_0/000000.left.depth.png
    def __init__(self, aug_params=None, root='/data/public_data/FallingThings/OpenDataLab___FAT/raw'):
        super().__init__(aug_params, reader=frame_utils.readDispFallingThings)
        assert os.path.exists(root)
...
class TartanAir(StereoDataset):#/data2/yijiayi_data/tartan_air/japanesealley/Easy/P001/image_left/000000_left.png
    def __init__(self, aug_params=None, root='/data2/yijiayi_data/tartan_air'):
        super().__init__(aug_params, reader=frame_utils.readDispTartanAir)
        assert os.path.exists(root)
...
class InStereo2K(StereoDataset):
    def __init__(self, aug_params=None, root='/data2/yijiayi_data/InStereo2K', split='training'):
        super(InStereo2K, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispInStereo2K, is_eval=split!="training")
        #/data2/yijiayi_data/InStereo2K/training/unzip_202603031207_part2/part2/000401/left_disp.png
        if split == "training":
            image1_list = sorted(glob(osp.join(root,'training/*/part*/*/left.png')))
        else:  #/data2/yijiayi_data/InStereo2K/test/unzip_202603031232_test/test/000040/left_disp.png
            image1_list = sorted(glob(osp.join(root, 'test/*/test/*/left.png')))
...
class CreStereo(StereoDataset):#/data/licanheng_data/CREStereo/stereo_trainset/crestereo/hole/001336a3-80c8-4ea9-a4bb-dcbf637988ba_right.disp.png
    def __init__(self, aug_params=None, root='/data/licanheng_data/CREStereo/stereo_trainset/crestereo'):
        super(CreStereo, self).__init__(aug_params, reader=frame_utils.readDispCreStereo)
...
class VKITTI2(StereoDataset):
    def __init__(self, aug_params=None, root='/data2/yijiayi_data/vkitti/unzip_202603031214_vkitti_2'):
        super().__init__(aug_params, reader=frame_utils.readDispVKITTI2)
        #/data2/yijiayi_data/vkitti/unzip_202603031214_vkitti_2/Scene02/15-deg-left/frames/rgb/Camera_0/rgb_00000.jpg
        image1_list = sorted(glob(osp.join(root, 'Scene*/*/frames/rgb/Camera_0/rgb_*.jpg')))
        image2_list = sorted(glob(osp.join(root, 'Scene*/*/frames/rgb/Camera_1/rgb_*.jpg')))
        root = '/data2/yijiayi_data/vkitti/unzip_202603031236_vkitti_2'
        disp1_list = sorted(glob(osp.join(root, 'Scene*/*/frames/depth/Camera_0/depth_*.png')))
        disp2_list = sorted(glob(osp.join(root, 'Scene*/*/frames/depth/Camera_1/depth_*.png')))
