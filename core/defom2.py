...
class DEFOMStereo(nn.Module):
    def __init__(self, args):
        ...
        self.update_block = BasicSelectiveMultiUpdateBlock(self.args, hidden_dim=args.hidden_dims[0])
        self.scale_update_block = ScaleSelectiveMultiUpdateBlock(self.args, hidden_dim=args.hidden_dims[0])
