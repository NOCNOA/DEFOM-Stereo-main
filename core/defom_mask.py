...
from core.submodules import build_gwc_volume, build_concat_volume, ConfidenceNet3D, ResnetBasicBlock3D, BasicConv, FeatureAtt, CostVolumeDisparityAttention, ChannelAttentionEnhancement, SpatialAttentionExtractor
...
class DEFOMStereo(nn.Module):
    def __init__(self, args):
        ...
        self.ConfidenceNet3D = ConfidenceNet3D(32)
    ...
    def forward(self, image1, image2, iters=12, scale_iters=3, test_mode=False):
        ...
        with autocast(enabled=self.args.mixed_precision):
            ...
            mask = self.ConfidenceNet3D(volume)
